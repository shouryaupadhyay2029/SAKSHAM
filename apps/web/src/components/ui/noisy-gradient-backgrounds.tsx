...
const Noise: React.FC<NoiseProps> = ({
  ...
  patternAlpha = 15, // Muted for SAKSHAM visual calm
  intensity = 0.5, // Muted for SAKSHAM visual calm
}) => {
  ...
  return <canvas style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', pointerEvents: 'none', zIndex: 1 }} ref={grainRef} />;
};
...
const GradientBackground: React.FC<GradientBackgroundProps> = ({
  ...
  colors = [
    { color: '#FAF8F3', stop: '0%' },     // SAKSHAM Warm Ivory Base
    { color: '#FDFBF7', stop: '40%' },    // Lightened Cream Highlight
    { color: '#F3EFE4', stop: '75%' },    // Muted Secondary Cream
    { color: '#EBE6D7', stop: '100%' }    // Soft Border Sage/Cream transition
  ],
  enableNoise = true,
