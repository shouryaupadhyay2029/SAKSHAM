...
// ShaderBackground — WebGL Wave shader adapted for SAKSHAM Operations pages
// Zero dependencies: one WebGL canvas that fills its parent.
// Usage: <div className="relative"><ShaderBackground className="absolute inset-0" />…
...
// SAKSHAM Operations palette: warm ivory → soft amber → cream
// Very low intensity so data tables remain crisp and readable
const UNIFORMS = {
  colors: [
...
export function ShaderBackground({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    const resizeCanvas = () => {
      ...
      // Cap pixels to 2M for performance
