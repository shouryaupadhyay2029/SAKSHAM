    ...
    <div className={styles.parallax} ref={parallaxRef}>
      <section className={styles.parallaxHeader}>
        <div className={styles.parallaxVisuals}>
          <div className={styles.blackLineOverflow}></div>
          <div data-parallax-layers className={styles.parallaxLayers}>
            ...
            <div data-parallax-layer="3" className={styles.parallaxLayerTitle}>
              <h2 className={styles.parallaxTitle}>Parallax</h2>
            </div>
            <img 
      ...
      <section className={styles.parallaxContent}>
        <svg xmlns="http://www.w3.org/2000/svg" width="100%" viewBox="0 0 160 160" fill="none" className={styles.osmoIconSvg}>
